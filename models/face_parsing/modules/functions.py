...
_VERBOSE_BUILD = os.environ.get("HAIRCLIP_VERBOSE_EXTENSIONS", "1").strip().lower() not in {
    "0",
    "false",
    "no",
}
...
if _VERBOSE_BUILD:
    print("[Startup] Loading face parsing inplace_abn CUDA op...", flush=True)
...
if _VERBOSE_BUILD:
    print("[Startup] Face parsing inplace_abn CUDA op ready.", flush=True)
