...
INTERMEDIATE_KEY_ALIASES = {
    ...
    "cv2_preclean_result": "pipeline_cv2_preclean_result",
    "post_composite_input_rgb": "pipeline_post_composite_input_rgb",
    "post_after_cutoff_cleanup_rgb": "pipeline_post_after_cutoff_cleanup_rgb",
    "post_after_residual_cleanup_rgb": "pipeline_post_after_residual_cleanup_rgb",
    "lama_post_cleanup_mask": "pipeline_lama_post_cleanup_mask",
